_base_ = [
    '../_base_/models/deeplabv3plus_r101-d16.py',
...
train_pipeline = [
    ...
    dict(type='PackSegInputs') # to pack inputs
]
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', reduce_zero_label=False),
...
vis_backends = [
    ...
    dict(type='ClearMLVisBackend', init_kwargs=dict(project_name='mmseg-benchmarking', task_name='deeplabv3plus_r101_d16'))
]
visualizer = dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path='base/img/train', seg_map_path='base/labels/train'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        reduce_zero_label=False,
        data_prefix=dict(
            img_path='base/img/val', seg_map_path='base/labels/val'),
